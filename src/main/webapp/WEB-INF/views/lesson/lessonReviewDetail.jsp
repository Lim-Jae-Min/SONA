	...
	<%@ include file="layout/lessonheader.jsp"%>
	 ...
	 <div class="review-title">${review.REVIEW_TITLE}</div>
        ...
        <c:forEach items="${photos}" var="photo">
			<img src="/photos/${photo.NEW_FILENAME}"/>
			<br/><br/>
		</c:forEach>	
        </div>
        <div>
        <button class="button blind" onclick="confirmBlind()">블라인드</button>
        </div>
        <div class="button-container">	
            <button class="button report" onclick="confirmReport()">신고</button>
            <button class="button edit" onclick="location.href='lessonReviewEdit?idx=${review.REVIEW_IDX}'">수정</button>
