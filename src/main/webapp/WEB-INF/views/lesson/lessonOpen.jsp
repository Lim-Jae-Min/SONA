	        	...
	        	<table id="lessonContent">
	        		...
	        		<tr>
	        			<td colspan="3">
		        			...
		        			<br/><br/>
		        			<textarea cols="100" wrap="hard" name="class_content" placeholder="내용을 입력해주세요." id="classContent"></textarea>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td colspan="3">
	        		...
	        		<tr>
	        			<td colspan="3">
		        			...
		        			<br/><br/>
		        			<textarea cols="100" wrap="hard" name="career_content" placeholder="내용을 입력해주세요."></textarea>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td colspan="3">
