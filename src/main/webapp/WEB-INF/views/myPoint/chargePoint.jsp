...
<body>
    ...
    <form action="">
	    ...
	    <div class="container">
	        ...
	        <div class="form-group">
	            ...
	            <input type="number" id="chargeAmount" name="chargeAmount" onkeyup="calculatePoints()">
	        </div>
	        ...
	        <div class="point-info">
	            <p>보유 포인트: <span id="currentPoints">0</span></p>
    ...
    <script>
        ...
        function calculatePoints() {
            ...
            var currentPoints = 1000;

            // 결제 방식 선택 여부 확인
            var paymentMethod = document.querySelector('input[name="paymentMethod"]:checked');

            // 결제 방식에 따라 결제 금액 설정 (여기서는 임의의 값으로 대체)
            var paymentAmount = chargeAmount;
            if (paymentMethod) {
