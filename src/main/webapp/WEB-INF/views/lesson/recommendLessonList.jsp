...
<body>
	...
	<div id="content">
		<div id="top">
			<br /> <b class="highlight">${loginName}</b>님을 위한 추천 강의 <br />
			<br /> <b class="highlight">${loginName}</b>님이 선호하는 악기 <b
				class="highlight">${myInst}</b> 추천 강의입니다. <span id="searchbox">
				<select name="condition" id="condition">
					<option value="class_name">강의명</option>
					<option value="user_name">강사명</option>
					<option value="class_location">지역</option>
			</select> <input type="text" id="searchContent"> <input type="button"
				value="검색">
			</span>
		</div>
		<br />
