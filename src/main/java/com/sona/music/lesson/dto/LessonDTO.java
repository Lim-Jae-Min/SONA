...
public class LessonDTO {
	...
	public int getNeed_inst() {
		return need_inst;
	}
	public void setNeed_inst(int need_inst) {
		this.need_inst = need_inst;
	}
	...
	public void setClass_times(int class_times) {
	...
	public int getClass_disable() {
		return class_disable;
	}
	public void setClass_disable(int class_disable) {
		this.class_disable = class_disable;
	}
	public int getClass_delete() {
		return class_delete;
	}
